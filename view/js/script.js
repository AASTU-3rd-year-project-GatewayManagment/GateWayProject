...
function submitPass(oldP, newP, confirmP) {
    ...
    xmlhttp.open("get", "../../controller/changePass.php?q=" + passInfoJson, true);
    xmlhttp.send();
...
function changeEmail(email, password) {
    ...
    xmlhttp.open("get", "../../controller/changePass.php?email=" + passInfoJson, true);
    xmlhttp.send();
...
function createAccount(ID, userName, password, repassword) {
    ...
    xmlhttp.open("get", "../../controller/admin.php?q=" + passInfoJson, true);
    xmlhttp.send();
}
